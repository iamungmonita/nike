...
import { getAllFeatured, getAllPopular, getAllTrending, getAllShopSport } from '@/service'
...
const index = () => {
    return (
        <>
            <BannerBackground background={image1} btnText='Shop' btnBgColor={true} titleStart='EXTRA 20% OFF' titleEnd='SELECT STYLE' textStart="Members: Sign in and use code READY at check out. Ends 8/27." textEnd="Exclusions apply." />
            <AutoSlider />
            ...
            <BannerBackground background={image4} btnText='Shop All' btnBgColor={false} MainTitle={`Day One's Coming Fast`} titleStart='BACK TO SCHOOL' titleEnd='ESSENTIALS' textStart="Score everything you'll need from day one and beyond." />
